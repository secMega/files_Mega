...
if hash or Bot(msg) or DevMega(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevMega(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevMega(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevMega(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevMega(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
...
elseif database:sismember(bot_id.."Mega:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Mega:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."Mega:Constructor"..chat_id, user_id) then
...
if database:sismember(bot_id.."Mega:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if text == ("مسح قائمه العام") and DevMega(msg) then
...
database:set(bot_id.."Mega:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."Mega:Link_Group"..msg.chat_id_) 
...
if text == "ترتيب الاوامر" and Constructor(msg) then
 ...
 database:set(bot_id.."Mega:Set:Cmd:Group:New1"..msg.chat_id_..":حذ","حذف رد")
 database:sadd(bot_id.."Mega:List:Cmd:Group:New"..msg.chat_id_,"حذ")
 database:set(bot_id.."Mega:Set:Cmd:Group:New1"..msg.chat_id_..":ت","تثبيت")
 database:sadd(bot_id.."Mega:List:Cmd:Group:New"..msg.chat_id_,"ت")
...
local NumMsg = database:get(bot_id..'Mega:messageUser'..data.chat_id_..':'..data.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."Mega:Comd:New:rt:User:"..data.chat_id_..Id) or Get_Rank(Id,data.chat_id_)
local message_edit = database:get(bot_id..'Mega:message_edit'..data.chat_id_..data.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Add:Num"..data.chat_id_..data.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."Mega:Add:Memp"..data.chat_id_..":"..data.sender_user_id_) or 0
...
local Id = users[2]
local NumMsg = database:get(bot_id..'Mega:messageUser'..data.chat_id_..':'..users[2]) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."Mega:Comd:New:rt:User:"..data.chat_id_..Id) or Get_Rank(Id,data.chat_id_)
local message_edit = database:get(bot_id..'Mega:message_edit'..data.chat_id_..users[2]) or 0
local Num_Games = database:get(bot_id.."Tshak:Add:Num"..data.chat_id_..users[2]) or 0
local Add_Mem = database:get(bot_id.."Mega:Add:Memp"..data.chat_id_..":"..users[2]) or 0
local Total_Photp = (taha.total_count_ or 0)
local Texting = {
'صورتك فدشي 😘😔❤️',
"صارلك شكد مخليه ",
...
if database:sismember(bot_id.."Mega:Sudo:User",result.sender_user_id_) then
dev = "• تم تنزيله من المطورين"
else 
dev = "• هو ليس مطور" 
end
if database:sismember(bot_id.."Mega:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "• تم تنزيل من الاساسيين" 
else 
crr = "• هو ليس منشئ اساسي" 
end
if database:sismember(bot_id.."Mega:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "• تم تنزيله من المنشئين" 
else 
cr = "• هو ليس منشئ" 
end
if database:sismember(bot_id.."Mega:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "• تم تنزيله من المدراء" 
else 
own = "• هو ليس مدير" 
end
if database:sismember(bot_id.."Mega:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "• تم تنزيله من الادميه"
 else 
mod = "• هو ليس ادمن" 
end
if database:sismember(bot_id.."Mega:Special:User"..msg.chat_id_, result.sender_user_id_) then
...
local Description = Texting[math.random(#Texting)]
local get_id = database:get(bot_id.."Mega:Klesh:Id:Bot"..msg.chat_id_) or database:get(bot_id.."Mega:KleshIDALLBOT")
if not database:get(bot_id..'Mega:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
keyboard.inline_keyboard = {
{
{text = 'م1', callback_data=msg.sender_user_id_.."/م1"},{text = 'م2', callback_data=msg.sender_user_id_.."/م2"},{text = 'م3', callback_data=msg.sender_user_id_.."/م3"},
},
{
{text = 'م4', callback_data=msg.sender_user_id_.."/م4"},
},
{
...
if Text and Text:match('(.*)/م1') and Addictive(tahaj) then
if tonumber(Text:match('(.*)/م1')) == tonumber(data.sender_user_id_) then
local Text =[[
• اوامر حمايه المجموعه
...
keyboard.inline_keyboard = {
{
{text = 'م1', callback_data=data.sender_user_id_.."/م1"},{text = 'م2', callback_data=data.sender_user_id_.."/م2"},{text = 'م3', callback_data=data.sender_user_id_.."/م3"},
},
{
{text = 'م4', callback_data=data.sender_user_id_.."/م4"},
},
{
{text = 'م5', callback_data=data.sender_user_id_.."/م5"},
},
{
{text = 'الاوامر الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Text)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end
if Text and Text:match('(.*)/م2') and Addictive(tahaj) then
if tonumber(Text:match('(.*)/م2')) == tonumber(data.sender_user_id_) then
local Text =[[
• اوامر الادمنيه
...
if Text and Text:match('(.*)/م3') and Owner(tahaj) then
if tonumber(Text:match('(.*)/م3')) == tonumber(data.sender_user_id_) then
local Text =[[
• اوامر المدير
— — — — — — — — — 
• رفع القيود
...
if Text and Text:match('(.*)/م4') and Constructor(tahaj) then
if tonumber(Text:match('(.*)/م4')) == tonumber(data.sender_user_id_) then
local Text =[[
• اوامر المنشئين الاساسين 
 — — — — — — — — — 
• رفع/تنزيل منشئ اساسي
...
if Text and Text:match('(.*)/م5') and DevBot(tahaj) then
if tonumber(Text:match('(.*)/م5')) == tonumber(data.sender_user_id_) then
local Text =[[
• اوامر المطور الاساسي  
...
if Text and Text:match('(.*)/الاوامر') and Addictive(tahaj) then
...
database:del(bot_id.."Mega:Link_Group"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:del(bot_id.."Mega:Chek:Welcome"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:set(bot_id.."Mega:Reply:Sudo"..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:set(bot_id..'Mega:Lock:ID:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:set(bot_id..'Mega:Lock:ID:Bot:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:set(bot_id.."Mega:Kick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:set(bot_id.."Mega:Reply:Manager"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:set(bot_id.."Mega:Link_Group"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:set(bot_id.."Mega:Chek:Welcome"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:del(bot_id.."Mega:Reply:Sudo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:del(bot_id..'Mega:Lock:ID:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:del(bot_id..'Mega:Lock:ID:Bot:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:del(bot_id.."Mega:Kick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
database:del(bot_id.."Mega:Reply:Manager"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/الاوامر"},
...
{
{text = 'العوده', callback_data=data.sender_user_id_.."/الاوامر"},
},
}
...
database:set(bot_id.."Mega:Lock:AddMempar"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
database:set(bot_id.."Mega:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:User:Name"..Chat_id,"del") 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Sticker"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Animation"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Video"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Photo"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Audio"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:vico"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Document"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Contact"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Spam"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hset(bot_id.."Mega:flooding:settings:"..Chat_id ,"flood","del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."Mega:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:AddMempar"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:text"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Join"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Bot:kick"..Chat_id)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:edit"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Link"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Spam"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hdel(bot_id.."Mega:flooding:settings:"..Chat_id ,"flood")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."Mega:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
send(msg.chat_id_, msg.id_,'• عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'Mega:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Mega:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'• المجموعه مفعله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','• تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'Mega:Chek:Groups',msg.chat_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'Mega:Chek:Groups',msg.chat_id_) then
...
Reply_Status(msg,result.id_,'reply_Add','• تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'Mega:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'Mega:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
inline = {
{{text = '•  VeCto𝖲??𝗎𝗋𝖼𝖾  .',url='http://t.me/TeAm_VeCto'}},
}
...
local Text ="• تم اللغاء منع كل المتحركات"
inline = {
{{text = '•  VeCto𝖲𝗈𝗎??𝖼𝖾  .',url='http://t.me/TeAm_VeCto'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
